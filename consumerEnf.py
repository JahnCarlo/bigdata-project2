...
def updateHashtags(spark):
    try:
        ...
        f = open('/home/jahnbigdata/bigdata-project2/out/hashtags.txt', 'a')
...
def updateTexts(spark):
    try:
        ...
        f = open('/home/jahnbigdata/bigdata-project2/out/texts.txt', 'a')
...
def updateScreenNames(spark):
    try:
        ...
        f = open('/home/jahnbigdata/bigdata-project2/out/screennames.txt', 'a')
        f.write(str(snDict))
        f.write("\n")
        f.close()
...
if __name__ == "__main__":
    ...
    sc = SparkContext(appName="ConsumerEnf")
    consumer()
